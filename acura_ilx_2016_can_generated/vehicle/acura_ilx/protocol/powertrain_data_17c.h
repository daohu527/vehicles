...
class Powertraindata17c : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  int pedal_gas(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool gas_pressed(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool acc_status(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int boh_17c(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool brake_switch(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int boh2_17c(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool brake_pressed(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int boh3_17c(const std::uint8_t* bytes, const int32_t length) const;
