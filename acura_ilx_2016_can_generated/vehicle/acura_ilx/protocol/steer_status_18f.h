...
class Steerstatus18f : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double steer_torque_sensor(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double steer_angle_rate(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Steer_status_18f::Steer_statusType steer_status(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool steer_control_active(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int steer_config_index(const std::uint8_t* bytes, const int32_t length) const;
