...
class Seatbeltstatus305 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  bool seatbelt_driver_lamp(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool seatbelt_pass_unlatched(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool seatbelt_pass_latched(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool seatbelt_driver_unlatched(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool seatbelt_driver_latched(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool pass_airbag_off(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool pass_airbag_on(const std::uint8_t* bytes, const int32_t length) const;
