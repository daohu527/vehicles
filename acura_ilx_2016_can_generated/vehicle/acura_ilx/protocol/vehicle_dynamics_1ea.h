...
class Vehicledynamics1ea : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double lat_accel(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double long_accel(const std::uint8_t* bytes, const int32_t length) const;
