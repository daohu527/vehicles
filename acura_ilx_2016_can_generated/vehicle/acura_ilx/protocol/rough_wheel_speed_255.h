...
class Roughwheelspeed255 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  int wheel_speed_fl(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int wheel_speed_fr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int wheel_speed_rl(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int wheel_speed_rr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int set_to_x55(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int set_to_x55_2(const std::uint8_t* bytes, const int32_t length) const;
