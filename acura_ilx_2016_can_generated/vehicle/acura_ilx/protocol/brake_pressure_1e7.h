...
class Brakepressure1e7 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double brake_pressure1(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double brake_pressure2(const std::uint8_t* bytes, const int32_t length) const;
