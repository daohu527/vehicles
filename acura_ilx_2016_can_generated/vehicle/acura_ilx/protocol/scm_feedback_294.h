...
class Scmfeedback294 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  bool right_blinker(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool left_blinker(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int wipers_speed(const std::uint8_t* bytes, const int32_t length) const;
};
