...
class Stalkstatus237b : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Stalk_status_2_37b::WipersType wipers(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool low_beams(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool high_beams(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool park_lights(const std::uint8_t* bytes, const int32_t length) const;
