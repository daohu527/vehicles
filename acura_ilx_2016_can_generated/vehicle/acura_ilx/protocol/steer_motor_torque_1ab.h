...
class Steermotortorque1ab : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  bool config_valid(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int motor_torque(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool output_disabled(const std::uint8_t* bytes, const int32_t length) const;
